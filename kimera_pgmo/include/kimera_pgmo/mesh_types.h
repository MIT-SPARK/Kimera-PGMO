 ...
 * position. Custom traits can derive from this struct and will be passed correctly through pgmo.
 * TODO(lschmid): Note that the mesh IO is hard coded to only save these traits currently.
 */
struct VertexTraits {
